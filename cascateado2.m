...
Curva_erbio                            = {6.8918    2.8002    0.0001    6.7193};
...
gain_dB                                = Curva_erbio{1}/(sqrt(Curva_erbio{2} + Curva_erbio{3}*Pp0^Curva_erbio{4}));                                     % EDFA gain in dBs 
...
gain_dB = Curva_erbio{1}/(sqrt(Curva_erbio{2} + Curva_erbio{3}*Pp0^Curva_erbio{4}));
